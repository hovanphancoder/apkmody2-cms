      ...
      <section class="section-recently-updated">
            <div class="container"><a href="/games" aria-label="View all games">
                ...
                <div class="flex-cat-container">
                    <div class="flex-cat-item active"><a href="/games" aria-label="View all games">All</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/action" aria-label="action games">Action</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/adventure" aria-label="adventure games">Adventure</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/arcade" aria-label="arcade games">Arcade</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/board" aria-label="board games">Board</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/card" aria-label="card games">Card</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/casual" aria-label="casual games">Casual</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/educational" aria-label="educational games">Educational</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/farming" aria-label="farming games">Farming</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/fighting" aria-label="fighting games">Fighting</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/football" aria-label="football games">Football</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/horror" aria-label="horror games">Horror</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/moba" aria-label="moba games">MOBA</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/music" aria-label="music games">Music</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/nsfw" aria-label="nsfw games">NSFW</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/platformer" aria-label="platformer games">Platformer</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/puzzle" aria-label="puzzle games">Puzzle</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/racing" aria-label="racing games">Racing</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/rpg" aria-label="rpg games">Role-playing</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/shooter" aria-label="shooter games">Shooter</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/simulation" aria-label="simulation games">Simulation</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/sports" aria-label="sports games">Sports</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/strategy" aria-label="strategy games">Strategy</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/survival" aria-label="survival games">Survival</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/tower-defense" aria-label="tower-defense games">Tower Defense</a></div>
                    <div class="flex-cat-item">
                        <a href="/games/visual-novel" aria-label="visual-novel games">Visual Novel</a></div>
                </div>
