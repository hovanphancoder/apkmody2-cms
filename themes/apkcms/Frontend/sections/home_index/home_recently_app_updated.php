        ...
        <section class="section-recently-updated">
            <div class="container"><a href="/apps" aria-label="View all apps">
                ...
                <div class="flex-cat-container">
                    <div class="flex-cat-item active"><a href="/apps" aria-label="View all apps">All</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/art-design" aria-label="art-design apps">Art &amp; Design</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/communication" aria-label="communication apps">Communication</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/education" aria-label="education apps">Education</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/emulator" aria-label="emulator apps">Emulator</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/entertainment" aria-label="entertainment apps">Entertainment</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/finance" aria-label="finance apps">Finance</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/hacking-tools" aria-label="hacking-tools apps">Hacking Tools</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/health-fitness" aria-label="health-fitness apps">Health &amp; Fitness</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/house-home" aria-label="house-home apps">House &amp; Home</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/music-audio" aria-label="music-audio apps">Music &amp; Audio</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/nsfw-apps" aria-label="nsfw-apps apps">NSFW</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/personalization" aria-label="personalization apps">Personalization</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/photos-videos" aria-label="photos-videos apps">Photos &amp; Videos</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/productivity" aria-label="productivity apps">Productivity</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/shopping" aria-label="shopping apps">Shopping</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/social" aria-label="social apps">Social</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/sports-apps" aria-label="sports-apps apps">Sports</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/travel-local" aria-label="travel-local apps">Travel &amp; Local</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/utilities" aria-label="utilities apps">Utilities</a></div>
                    <div class="flex-cat-item">
                        <a href="/apps/weather" aria-label="weather apps">Weather</a></div>
                </div>
